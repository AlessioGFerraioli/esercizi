...
while continuare_gioco == True:
    ...
    try:
        ...
        if numero_1 == numero_2:
            ...
            if numero_2 - numero_1 > 5000:
                print("L'intervallo è troppo grande.")
                print("L'ampiezza massima consentita per l'intervallo è 5000.")
                break
            ...
            if len(divisori) == 0:
                print("Nessun numero primo trovato nell'intervallo.")
            else:
